...
```csharp
public static System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<GithubClient.Repositories.Repository>>? GetOrgRepositories(string PAT, string Org);
```
#### Parameters
