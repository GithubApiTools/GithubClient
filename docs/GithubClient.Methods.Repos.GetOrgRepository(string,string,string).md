...
```csharp
public static System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<GithubClient.Repositories.Repository>>? GetOrgRepository(string PAT, string Org, string Name);
```
#### Parameters
