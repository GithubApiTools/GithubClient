...
```csharp
public static System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<GithubClient.Repositories.ContentDirectory>>? GetContents(string PAT, string Owner, string Name);
```
#### Parameters
