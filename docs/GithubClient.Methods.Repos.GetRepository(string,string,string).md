...
```csharp
public static System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<GithubClient.Repositories.Repository>>? GetRepository(string PAT, string Owner, string Name);
```
#### Parameters
