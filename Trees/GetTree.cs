...
namespace GithubClient.Trees
{
    ...
    public class Methods
    {
        ...
        public static async Task<TreeRoot> GetTree(string PAT, string GithubUrl, string Owner, string Name, string Ref = "main")
        {
            ...
            return JsonSerializer.Deserialize<TreeRoot>(await Response);
        }
        /// <summary>
        /// Returns a repository Tree from the Github API
        /// </summary>
        ...
        /// <returns>A tree object</returns>
        public static async Task<TreeRoot> GetTree(string PAT, string GithubUrl, Repository repository, string Ref = "main", bool Recursive = true)
        {
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(GithubUrl);
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/vnd.github.v3+json"));
